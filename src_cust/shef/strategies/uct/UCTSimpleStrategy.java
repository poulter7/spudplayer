...
public final class UCTSimpleStrategy extends UCTGamer {
	 ...
	 */
	protected List<Double> completeRollout(final MachineState from, final int fromLvl) throws TransitionDefinitionException, MoveDefinitionException, GoalDefinitionException {
