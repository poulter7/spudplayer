 ...
 * @author Sam
 */
public final class SputbotPythonGamerStub extends PythonGamer
{
    protected String getPythonGamerModule() { return "spudbot"; }
    protected String getPythonGamerName() { return "SpudbotGamer"; }
}
