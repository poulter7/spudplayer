...
public class PropNetStateMachine extends StateMachine {
    /** The underlying proposition shef.network  */
	...
	/**
	 * Computes the legal roles for role in state.
	 */
	@Override
	public List<Move> getLegalMoves(MachineState state, Role role)
	throws MoveDefinitionException {
		// TODO: Compute legal roles.
		return null;
	}
	
	/**
	 * Computes the next state given state and the list of roles.
	 */
	@Override
