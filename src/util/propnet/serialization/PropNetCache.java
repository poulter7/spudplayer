 ...
 * when loading the PropNetCache can verify that it is getting the shef.network for
...
public class PropNetCache {
    ...
    public static PropNet loadNetworkFromCache(List<Gdl> description) {
        ...
        // Deserialize the original description and shef.network.
        ...
        for(int i = 0; i < description.size(); i++) {
            if(!description.get(i).toString().equalsIgnoreCase(oldDescription.get(i).toString())) {
