...
import util.configuration.GamerConfiguration;
 ...
 * Gamer process and the GGP server: it ensures that legal roles are sent back
 * to the server on time, accepts and stores working roles, and so on.
 * 
 ...
 *     
 *  2. You can send "working roles" to the proxy, so that if your Gamer process
